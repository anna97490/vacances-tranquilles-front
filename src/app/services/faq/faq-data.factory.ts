...
export class FAQDataFactory {
   ...
   * Une seule source de vérité pour toutes les données FAQ
   */
  private static readonly FAQ_COMPLETE_DATA: FAQCompleteData = {
    particulier: {
      parcours: [
  ...
  static generateParticulierFAQ(): FAQParticulierParcours[] {
    return this.generateFAQWithOrder<FAQParticulierParcours>(
      this.FAQ_COMPLETE_DATA.particulier.parcours, 
      'part'
    );
  }
  ...
  static generatePrestataireFAQ(): FAQPrestataireParcours[] {
    return this.generateFAQWithOrder<FAQPrestataireParcours>(
      this.FAQ_COMPLETE_DATA.prestataire.parcours, 
      'presta'
    );
  }
  ...
  static generateParticulierStandardFAQ(): FAQParticulierItem[] {
    return this.transformToStandardFAQ(this.FAQ_COMPLETE_DATA.particulier.standard);
  }
  ...
  static generatePrestataireStandardFAQ(): FAQPrestataireItem[] {
    return this.transformToStandardFAQ(this.FAQ_COMPLETE_DATA.prestataire.standard);
  }
  ...
  static generateGeneralStandardFAQ(): FAQItem[] {
    return this.transformToStandardFAQ(this.FAQ_COMPLETE_DATA.general.standard);
  }
